...
Sin embargo, este método presenta importantes limitaciones, especialmente en el contexto de series temporales. En particular, no tiene en cuenta la dependencia temporal entre observaciones, como la autocorrelación o la estacionalidad, lo que puede generar imputaciones poco realistas. Asimismo, la naturaleza aleatoria del procedimiento puede introducir ruido artificial en la serie, afectando la coherencia de los datos imputados. Por otra parte, los resultados pueden variar entre ejecuciones si no se fija una semilla, lo que puede dificultar la reproducibilidad.
